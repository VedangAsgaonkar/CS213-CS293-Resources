...
namespace Sort
{
    std::pair<long long int,long long int> QSP1(int* arr , int n );
    std::pair<long long int,long long int> QSRP(int* arr , int n );
    std::pair<long long int,long long int> BuSo(int* arr , int n );    
} // namespace Sort

namespace ArrayGenerator
{
    int* randomArray(int n);
    int* almostSorted(int n, double fraction);
    int* almostReversed(int n, double fraction);
}